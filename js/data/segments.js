// End-of-game segmentation — "Your Neuralift segment".
...
export const SEGMENTS = [
  {
    ...
    tip: 'Neuralift recommends: any interaction. Literally any.',
  },
  {
    ...
    tip: 'Neuralift recommends: water. Retroactively.',
  },
  {
    ...
    tip: 'Neuralift notes: an improbable share of your pipeline has "agreed at 2am" in the notes field.',
  },
  {
    ...
    tip: 'Neuralift has reclassified your "client entertainment" line as "entertainment".',
  },
  {
    ...
    tip: 'Neuralift recommends: never returning. Legends don’t do sequels.',
  },
  {
    ...
    tip: 'Neuralift admires the unit economics.',
  },
  {
    ...
    tip: 'Neuralift has segmented your expenses under "Ambience".',
  },
  {
    ...
    tip: 'Neuralift confirms: the Palais was never where the leads were.',
  },
  {
  ...
  },
  {
    ...
    tip: 'Neuralift predicts: a bigger budget next year, and the curse that comes with it.',
  },
  {
    ...
    tip: 'Neuralift has flagged you as a statistical anomaly.',
  },
  {
    ...
    tip: 'Neuralift has segmented this trip as "holiday" and respectfully suggests you tell payroll.',
  },
  {
    ...
    tip: 'Neuralift values your network at roughly 3x your pipeline. Collect accordingly.',
  },
  {
    ...
    tip: 'Neuralift found nothing to flag, which has never happened before.',
  },
];
